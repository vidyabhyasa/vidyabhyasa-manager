  ...
  return `
    <div style="font-family:sans-serif;max-width:480px;margin:0 auto;">
      <div style="text-align:center;margin-bottom:12px;">
        <img src="${SITE_URL}/logo.jpeg" alt="Vidyabhyasa" style="width:64px;height:64px;border-radius:10px;">
      </div>
      <h2 style="color:#16324F;text-align:center;">Vidyabhyasa Study Center</h2>
      <p>Hi ${name},</p>
